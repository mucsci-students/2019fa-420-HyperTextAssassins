...
$(function() {
	...
	command.focus/// <reference path="classBlock.ts" />
...
function dropDownClick(className, option){
	...
	if (option === "function ") {
		...
		if (className == undefined) {
			...
			//TODO
           //Code to connect arrows between parent and child relationships.

           //Creates line.
            $('#blockArea').append('<svg><line stroke-width="5px" stroke="#000000" id="line' + className + '"          width="500" height="100"/></svg>');
  
            let line = $('#line' + className);
            let div2 = $('[name="' + connectParent + '"]');
            let div1 = $('[name="' + className + '"]');

            //Getting positions between the two divs.
            ...
            //Changing the attributes within the html to our div1 and div2 x and y coordinates. 
            line
         	.attr('x1', x1)
         	.attr('y1', y1)
         	.attr('x2', x2)
